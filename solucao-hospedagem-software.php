			...
			<div class="col-lg-12">
				<div class="breatcumb-content text-center">
					...
					<div class="breatcumb-content-text">
						<ul>
							<li><a href="#">home</a> <i class="fas fa-angle-double-right"></i> <span><a href="#">Soluções</a> <i class="fas fa-angle-double-right"></i></span> <span>Hospedagem de Software, Site e E-mail</span></li>
						</ul>
					</div>
				</div>
			</div>
